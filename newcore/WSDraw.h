...
extern DWORD DispHeight;		// 테″스후˚레이 높이, 폭
extern DWORD DispWidth;
...
//---------------------------------------------------------------------------
extern "C" int __fastcall WsDrawCreate(HWND hGbWnd);
...
//---------------------------------------------------------------------------
extern "C" void __fastcall WsDrawRelease(void);
...
extern "C" int __fastcall SetDrawMode(int Size, int Mode);
...
//---------------------------------------------------------------------------
extern "C" int __fastcall WsDrawLine(int Line);
...
//---------------------------------------------------------------------------
extern "C" int __fastcall WsDrawFlip(void);
...
//---------------------------------------------------------------------------
extern "C" void __fastcall SetPalette(int Index, byte PalData);
...
//---------------------------------------------------------------------------
extern "C" void __fastcall WsDrawClear(void);
...
//
//---------------------------------------------------------------------------
extern "C" int __fastcall GetLine(void);
